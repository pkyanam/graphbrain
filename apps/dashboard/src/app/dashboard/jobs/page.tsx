// Jobs — Phase 2 stub. The job queue API (GET /api/dashboard/jobs) returns 501.
// Show a "Coming in Phase 2" state; do NOT call the endpoint.
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-dashed border-neutral-300 bg-neutral-50 p-12 text-center">
        ...
        <p className="mt-1 text-xs text-neutral-400">
          The job queue (minions, autopilot) is not built in Phase 1.
        </p>
      </div>
    </div>
  );
